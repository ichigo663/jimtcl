# A simple debugger. All it needs is a way to
# set breakpoints and break at each command execution.
# Basically 'trace add execution' except perhaps unconditionally
# Tracing would be one-shot so it is disable once activated.
# The debugger would re-add the trace each time
